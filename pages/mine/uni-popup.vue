<template>
	<view>
		<view v-show="show" :style="{ top: offsetTop + 'px' }" :class="shareStatus ? '  uni_mask_two' : 'uni-mask'" @click="hide" @touchmove.stop.prevent="moveHandle" />
...
export default {
	...
	methods: {
		hide() {
			if (this.mode === 'insert' && this.position === 'middle')
				// return
				this.$emit('hidePopup');
		},
		closeMask() {
