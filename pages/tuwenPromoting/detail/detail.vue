		...
		<view class="tuwen_detail">
			<transition name="move">
				<view class="mask detail_wrap" :class="flag ? 'active' : ''" v-if="showSwiperValue" @tap="closeSwiper">
					<SwiperPic :swiperImg="detailData['esaLinkInfoList']"></SwiperPic>
				</view>
			</transition>
...
import SwiperPic from '../../../components/swiper-pic/swiper-pic.vue'; //引入轮播
...
export default {
	...
	components: { SwiperPic, hFormAlert, uniPopup, sharePage },
